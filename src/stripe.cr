...
module Stripe
  ...
  def self.request(method, url, api_key)
    self.request(method, url, api_key, {} of String => String)
  end

  def self.request(method, url, api_key, params)
    self.request(method, url, api_key, params, {} of String => String)
  end

  def self.request(method, url, api_key, params, headers)
    self.request(method, url, api_key, params, headers, nil)
  end

  def self.request(method : Symbol, url : String, params : Hash(String, String))
    self.request(method, url, nil, params)
  end
